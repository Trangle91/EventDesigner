...
//	public static Map<String, Florist> floristMap = Stream.of(
//		new AbstractMap.SimpleEntry<String, Florist>("Tommy Rose", new Florist("Tommy Rose", "612-551-1233", new BigDecimal("100.00"), new BigDecimal("30.00"), 
//					new BigDecimal("150.00"), Optional.of(new BigDecimal("300.00")))),
//		new AbstractMap.SimpleEntry<String, Florist>("Artemissa", new Florist("Artemissa", "651-091-0847", new BigDecimal("70.00"), 
//					new BigDecimal("20.00"), new BigDecimal("130.00"), Optional.ofNullable(new BigDecimal("400.00")))),
//		
//		new AbstractMap.SimpleEntry<String, Florist>("Bloom Flowers", new Florist("Bloom Flowers", "713-111-2222", new BigDecimal("100.00"), 
//				new BigDecimal("40.00"), new BigDecimal("200.00"), Optional.ofNullable(new BigDecimal("350.00")))),
//		
//		new AbstractMap.SimpleEntry<String, Florist>("Lake Harriet Flowers", new Florist("Lake Harriet Flowers", "713-234-0989", new BigDecimal("120.00"), 
//				new BigDecimal("50.00"), new BigDecimal("170.00"), Optional.ofNullable(new BigDecimal("350.00")))),
//		
//		new AbstractMap.SimpleEntry<String, Florist>("Rose Blossom", new Florist("Rose Blossom", "713-4343-4343", new BigDecimal("150.00"), 
//				new BigDecimal("50.00"), new BigDecimal("250.00"), Optional.ofNullable(new BigDecimal("500.00"))))		
//		
//	).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));
